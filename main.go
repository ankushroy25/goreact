...
func getTodos(c *fiber.Ctx) error {
	...
	// *CURSOR* is when we exectue a query in mongodb it returns a cursor which is essentially a pointer to results set and can be used to iterate over the objects
	if err != nil {
		return err
	}
